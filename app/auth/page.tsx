...
export default function AuthPage() {
  ...
  // State C: Not logged in → show Google button
  if (!firebaseUser) {
    return (
      <main className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-sm text-center">
          <h1 className="text-3xl font-bold mb-2">Vecindad</h1>
          <p className="text-gray-500 mb-8">El marketplace de tu barrio</p>
  ...
  // State B: Logged in but needs registration → show form
  if (needsRegistration) {
    return (
      <main className="min-h-screen px-4 py-8">
        <div className="w-full max-w-md mx-auto">
          <h1 className="text-2xl font-bold mb-1">Completá tu perfil</h1>
          <p className="text-gray-500 mb-6">
            Para usar Vecindad necesitamos saber de qué barrio sos.
          </p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              />
              <p className="mt-1 text-xs text-gray-400">Solo números, sin +54 ni guiones</p>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-blue-600 text-white font-medium rounded-lg px-4 py-3 hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
  ...
  // State A: Logged in with user → redirecting (handled by useEffect above)
  return (
    <div className="flex items-center justify-center min-h-screen">
